...
using ЯнтимировБД;
namespace ЯнтимировБД.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class WeatherForecastController : ControllerBase
    {
        ...
        [HttpDelete("DeleteCity/{id}", Name = "DeleteCity")]
    ...
    public class CityData
    {
        ...
        [Required(ErrorMessage = "Население обязательно")]
        [Range(1, int.MaxValue, ErrorMessage = "Население должно быть положительным числом")]
